/*
HL DECOMPOSITION
Suppose we have an unbalanced tree of n nodes,
we have to perform operations on the tree to answer a number of queries,
 each can be of one of the two types:
